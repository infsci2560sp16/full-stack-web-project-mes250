  ...
  grunt.initConfig({
    ...
    validation: {
      options: {
       ...
       relaxerror: ['The Content-Type was “text/html”. Using the HTML parser.', 'Using the schema for HTML with SVG 1.1, MathML 3.0, RDFa 1.1, and ITS 2.0 support.', 'Bad value X-UA-Compatible for attribute http-equiv on element meta.', 'Expected a conditional expression and instead saw an assignment.'] //ignores these errors
      },
      files: {
